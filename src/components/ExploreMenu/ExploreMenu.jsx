...
const ExploreMenu = ({ category, setCategory }) => {
  ...
  return (
    <div className='flex flex-col gap-5'>
      ...
      <h1 className='text-slate-900 text-center md:text-start text-3xl font-medium'>Explore our Menu</h1>
      <p className='md:max-w-[60%] '>Choose from a diverse menu featuring a delectable array of dishes crafted with the finest ingredients and culinary expertise. Our mission is to satisfy your cravings and elevate your dining experience, one delicious meal at a time.</p>
