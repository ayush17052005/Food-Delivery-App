...
const Navbar = () => {
  ...
  return (
    <div  className="navbar flex justify-between items-center py-3">
      ...
      <ul className="navbar-menu flex gap-12 text-[#49557e] list-none texNamet-lg ">
      ...
      <div className="navbar-right flex items-center gap-10">
        ...
        <button className="bg-transparent text-lg text-[#49557e] border-2 border-black px-7 py-2 rounded-full cursor-pointer transition duration-300 hover:bg-[#ededed]">Sign In</button>
        </div>
    </div>
  )
}
